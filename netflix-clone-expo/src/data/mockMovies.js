export const MOCK_MOVIES = [
  ...
  {
    id: 'mov_9',
    title: 'Avatar 3: Tro Tàn Và Lửa (Fire and Ash)',
    ...
    isUpcoming: true,
    viewCount: 4800000,
    genres: ['Khoa học viễn tưởng', 'Hành động', 'Phiêu lưu', 'Chiếu Rạp'],
    director: 'James Cameron',
    categoryTag: 'upcoming',
    overview: 'Chương tiếp theo về thế giới Pandora hé lộ bộ tộc Tro Tàn hiếu chiến và những bí mật sâu thẳm chưa từng được khám phá.',
    backdropUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=1200&auto=format&fit=crop&q=80',
    posterUrl: 'https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?w=600&auto=format&fit=crop&q=80',
    trailerUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4',
    videoSources: {
    ...
    subtitles: [{ language: 'Tiếng Việt', code: 'vi', label: 'Tiếng Việt' }],
    audioTracks: [{ language: 'Gốc (Tiếng Anh)', code: 'en_orig', label: 'Dolby Atmos 7.1' }]
  },
  {
    id: 'mov_10',
    title: 'Avengers: Cuộc Chiến Bí Mật (Secret Wars)',
    ...
    isUpcoming: true,
    viewCount: 5200000,
    genres: ['Hành động', 'Khoa học viễn tưởng', 'Siêu anh hùng', 'Chiếu Rạp'],
    director: 'Russo Brothers',
    categoryTag: 'upcoming',
    overview: 'Đa vũ trụ va chạm toàn diện, tập hợp toàn bộ các siêu anh hùng vĩ đại nhất lịch sử điện ảnh trong trận chiến quyết định số phận thực tại.',
    backdropUrl: 'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=1200&auto=format&fit=crop&q=80',
    posterUrl: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?w=600&auto=format&fit=crop&q=80',
    trailerUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    videoSources: {
    ...
    subtitles: [{ language: 'Tiếng Việt', code: 'vi', label: 'Tiếng Việt' }],
    audioTracks: [{ language: 'Gốc (Tiếng Anh)', code: 'en_orig', label: 'Dolby Atmos' }]
  },
  {
    id: 'mov_11',
    title: 'Lật Mặt 8: Vòng Tay Người Mẹ',
    originalTitle: 'Face Off 8: Mother\'s Arms',
    rating: 9.1,
    releaseYear: 2025,
    duration: '2h 15m',
    ...
    isUpcoming: true,
    viewCount: 3900000,
    genres: ['Tình cảm', 'Gia đình', 'Hài hước', 'Chiếu Rạp'],
    director: 'Lý Hải',
    categoryTag: 'upcoming',
    overview: 'Phần tiếp theo trong chuỗi thương hiệu bom tấn phòng vé Việt Nam của đạo diễn Lý Hải, mang đến câu chuyện gia đình cảm động chạm đến trái tim hàng triệu người.',
    backdropUrl: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=1200&auto=format&fit=crop&q=80',
    posterUrl: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=600&auto=format&fit=crop&q=80',
    trailerUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4',
    videoSources: {
    ...
    subtitles: [{ language: 'Tiếng Việt', code: 'vi', label: 'Tiếng Việt' }],
    audioTracks: [{ language: 'Gốc (Tiếng Việt)', code: 'vi_orig', label: 'Dolby Surround' }]
  }
];
